...
public class Movimentacao {
   ...
   // private Boolean status;
    ...
    public  void salvar(String dataEscolhida){
        ...
        String idUsuario = Base64Custom.codificarBase64( autenticacao.getCurrentUser().getEmail() );//Email
        String mesAno = DateCustom.mesAnoDataEscolhida( dataEscolhida );//Mes e ano
