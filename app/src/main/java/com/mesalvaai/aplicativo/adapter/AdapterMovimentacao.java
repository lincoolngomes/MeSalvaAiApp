package com.mesalvaai.aplicativo.adapter;
...
public class
AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if ( movimentacao.getTipo().equals("i")) {
            holder.valor.setTextColor(context.getResources().getColor(R.color.colorAccentInvestimentos));
            holder.valor.setText(">>" + movimentacao.getValor());
        }
